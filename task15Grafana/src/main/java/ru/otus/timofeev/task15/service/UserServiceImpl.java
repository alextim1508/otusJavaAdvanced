...
import ru.otus.timofeev.task15.repository.UserRepository;
import ru.otus.timofeev.task15.exception.ConflictException;
import ru.otus.timofeev.task15.exception.NotFoundException;
import ru.otus.timofeev.task15.model.User;

import java.util.List;

import static ru.otus.timofeev.task15.config.CacheConfig.CACHE_NAME;
