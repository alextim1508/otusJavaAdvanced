...
import ru.otus.timofeev.task9.exception.NotFoundException;
import ru.otus.timofeev.task9.model.User;
import ru.otus.timofeev.task9.repository.UserRepository;

import java.util.List;

import static ru.otus.timofeev.task9.config.CacheConfig.CACHE_NAME;
